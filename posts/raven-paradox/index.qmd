...
1. It is only applicable to hypotheses of universal conditional form, the applicability of the criterion is restricted to certain form of hypotheses. %TODO CITE
2. It does not fulfill *the* equivalence condition. It makes confirmation depend not only on content of the hypothesis but also on its formulation. %TODO CITE
